...
import dev.nukecraft5419.advancedexampleplugin.players.OfflinePlayer;
import dev.nukecraft5419.advancedexampleplugin.utils.BukkitUtils;
...
public class CommandArguments {
    ...
    public CommandArguments(AdvancedExamplePlugin plugin, Argument[] requiredArguments) {
        this.plugin = plugin;
