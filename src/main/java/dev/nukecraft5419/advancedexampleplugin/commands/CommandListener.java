...
import dev.nukecraft5419.advancedexampleplugin.utils.ArrayUtils;

public abstract class CommandListener implements CommandExecutor {
    protected Command command;
    protected AdvancedExamplePlugin plugin;
    ...
    public void register(AdvancedExamplePlugin plugin, boolean isSubCommand) {
        this.plugin = plugin;
